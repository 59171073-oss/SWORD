var ENEMY_IMAGES = {
    ...
    '恶霸头目': 'https://robohash.org/bully_boss?set=set3&bgset=bg1',
    '恶霸打手': 'https://robohash.org/bully_henchman?set=set3&bgset=bg1',
    '恶霸喽啰': 'https://robohash.org/bully_minion?set=set3&bgset=bg1',
    '寨门守卫': 'https://robohash.org/guard_gate?set=set3&bgset=bg1',
    '寨中刀手': 'https://robohash.org/knife_fighter?set=set3&bgset=bg1',
    '寨中剑手': 'https://robohash.org/sword_fighter?set=set3&bgset=bg1',
    '寨中暗手': 'https://robohash.org/shadow_assassin?set=set3&bgset=bg1',
    ...
    '头目·赤炎': 'https://robohash.org/chief_chiyan?set=set3&bgset=bg1',
    '头目护卫': 'https://robohash.org/chief_guard?set=set3&bgset=bg1',
    '头目剑客': 'https://robohash.org/chief_swordsman?set=set3&bgset=bg1',
    '头目暗手': 'https://robohash.org/chief_assassin?set=set3&bgset=bg1',
    '头目军师': 'https://robohash.org/chief_strategist?set=set3&bgset=bg1',
